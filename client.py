...
class ChatRoomGUI(QMainWindow):
    ...
    def initUI(self):
        ...
        self.create_server_password_label = QLabel("Chatroom Password (Optional):")
    ...
    # Method to check for incoming messages
    ...
    # Method to execute when create button is clicked
    def create_button_execute(self):
        try:
            ...
            if server_response == "CREATE_SUCCESS":
                ...
                self.open_chat_window(room_name, username)  # Open chat window
    ...
    def connect_to_server(self):
        try:
            ...
            server_address = "54.163.37.131"  # CHANGE THIS TO YOUR SERVER'S IP ADDRESS
            server_port = 2004  # CHANGE THIS TO YOUR SERVER'S PORT
    ...
    # Method to populate available rooms in the UI
